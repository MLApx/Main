...
train_ds=tf.keras.preprocessing.image_dataset_from_directory(
    '/deac/classes/egr315/tongh18/train/20x/',
    labels="inferred",
    label_mode="binary",
    class_names=None,
    color_mode="rgb",
...
model.save("/deac/classes/egr315/tongh18/20xbinarymodel02.h5")
...
plt.savefig('/deac/classes/egr315/tongh18/accuracy20xbinary02.png')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'validation'], loc='upper left')
plt.savefig('/deac/classes/egr315/tongh18/test1/loss20binaryx02.png')
plt.close()
import os
from PIL import Image

MN_ds=tf.keras.preprocessing.image_dataset_from_directory(
    '/deac/classes/egr315/tongh18/test_set/20x/MN',
    labels="inferred",
    label_mode="binary",
    class_names=None,
    color_mode="rgb",
...
z=model.predict(MN_ds)
z=np.where(z>0.5,1,0)
zcount=np.unique(znp,return_counts=True)
print(z)
print(zcount)
ad_ds=tf.keras.preprocessing.image_dataset_from_directory(
    '/deac/classes/egr315/tongh18/test_set/20x/adenocx',
    labels="inferred",
    label_mode="binary",
    class_names=None,
    color_mode="rgb",
